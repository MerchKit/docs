...
description: "Authenticate the API and MCP server: connect an agent with OAuth (no key), or use a workspace API key, with bearer mk_live_ tokens, one key per workspace, and a symmetric read/write/delete scope per resource."
---
