...
Agents can also connect to the [MCP server](/developers/mcp) over **OAuth** — one click, a sign-in,
and a workspace + scope choice, with no API key to manage.
...
<CardGroup cols={2}>
  ...
  <Card title="MCP server" icon="robot" href="/developers/mcp">
    Connect Claude, ChatGPT, or VS Code in one click — or over an API key.
  </Card>
