...
<Steps>
  ...
  <Step title="Read a product">
    ...
    [Conventions](/developers/conventions#resource-anatomy). Reading a wide catalog and only need a
    few keys? Add [`?fields=sku,price`](/developers/conventions#selecting-fields).
  </Step>
