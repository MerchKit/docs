...
| --- | --- | --- | --- |
| `Red, Blue, Green, Black, White` | A navy blue shirt | `Blue` |  |
| `Red, Blue, Green, Black, White` | A maroon burgundy sweater | `Red` (closest match) |  |
| `Red, Blue, Green, Black, White` | A gold-plated watch | `White` (closest match; no metallic option) |  |
